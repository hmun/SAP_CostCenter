...
Function delSAPCommandbar()
    ...
    For Each aCmdBar In aCmdBars
      If aCmdBar.NAME = "SAPCostcenter" Then
        aCmdBarExists = True
        Exit For
      End If
    Next
...
Attribute addSAPCommandbar.VB_ProcData.VB_Invoke_Func = " \n14"
    ...
    Else
      Set aCmdBar = aCmdBars.Add("SAPCostcenter", msoBarTop, , True)
        Dim aButton As CommandBarControl
        Set aButton = aCmdBar.Controls.Add(msoControlButton)
        With aButton
            .Style = msoButtonCaption
            .Caption = "Create CCs"
            .TooltipText = "Create cost centers"
            .OnAction = "SAP_CostCenter_create"
        End With
        Set aButton = aCmdBar.Controls.Add(msoControlButton)
        With aButton
            .Style = msoButtonCaption
            .Caption = "Change CCs"
            .TooltipText = "Change cost centers"
            .OnAction = "SAP_CostCenter_change"
        End With
        Set aButton = aCmdBar.Controls.Add(msoControlButton)
        With aButton
            .BeginGroup = True
